...
export default function AdminSidebar() {
  ...
  return (
    <div className="w-64 bg-[#1F6512] border-r border-[#1a5610] h-full flex flex-col rounded-r-[90px]"> {/* Added rounded-r-2xl */}
      <div className="p-6 border-b border-[#1a5610]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-white text-sm">hapsayRizal</h1> {/* Updated text */}
        ...
        <ul className="space-y-2">
          ...
          <li>
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${location.pathname === "/admin/appointments"
                ? "bg-[#1a5610] text-white"
                : "text-[#e8f5e9] hover:bg-[#1a5610] hover:text-white"
                }`}
            >
          ...
          <li>
            <Link
              to="/admin/reports"
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${location.pathname === "/admin/reports"
                ? "bg-[#1a5610] text-white"
                : "text-[#e8f5e9] hover:bg-[#1a5610] hover:text-white"
                }`}
            >
          ...
          <li>
            <Link
              to="/admin/help"
              className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${location.pathname === "/admin/help"
                ? "bg-[#1a5610] text-white"
                : "text-[#e8f5e9] hover:bg-[#1a5610] hover:text-white"
                }`}
            >
