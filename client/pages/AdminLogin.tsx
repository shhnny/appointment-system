  ...
  if (isLoading) {
    return (
      <div className="h-screen flex bg-white overflow-hidden">
        ...
        {/* Original page structure (visible) */}
          ...
          <div className="flex flex-col items-center justify-center flex-1 min-h-0 p-6">
            ...
            <div className="w-full max-w-sm">
              <div className="space-y-4 opacity-50">
                ...
                <button
                  disabled
                  className="w-full px-6 py-4 bg-primary/50 text-primary-foreground font-semibold rounded-lg mt-6 cursor-not-allowed"
                >
                  Log In
                </button>
              </div>
