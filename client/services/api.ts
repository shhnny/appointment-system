    ...
    const formattedData = {
      ...
      service_id:
        typeof data.service_id === "string"
          ...
          : data.service_id,
      time_slot_id:
        typeof data.time_slot_id === "string"
          ? parseInt(data.time_slot_id)
          : data.time_slot_id,
    };
  ...
  getDashboardStats(): Promise<{
    ...
    return Promise.all([
      ...
      return {
        ...
        pending_appointments: appointments.filter((a) => a.status_id === 1)
          .length,
        completed_appointments: appointments.filter((a) => a.status_id === 3)
          .length,
